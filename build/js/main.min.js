...
var swiper2 = new Swiper('.slider--2 .swiper-container', {
  loop: true,
  slidesPerView: 'auto',
  speed: 1000,
  pagination: {
...
var removeItemActiveClass = function removeItemActiveClass(arr) {
  arr.forEach(function (el) {
    el.classList.add('no-opacity'); // setTimeout(() => {

    el.classList.add('hide'); // }, 250);
  });
};
...
var initTabAction = function initTabAction(controls, cleanItems) {
  controls.forEach(function (control, index) {
    control.addEventListener('click', function (e) {
      ...
      control.classList.add('active'); // setTimeout(() => {

      cleanItems[index].classList.remove('no-opacity'); // }, 300);
      // setTimeout(() => {

      cleanItems[index].classList.remove('hide'); // }, 310);
    });
  });
};
